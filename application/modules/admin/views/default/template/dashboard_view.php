...
$status = json_decode(@file_get_contents(get_author_url().'admin/verify/checkversion/whizbiz'));
...
<div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        <a href="http://dbcinfotech.net/app/whizbiz/codecanyon/doc" target="_blank" class="btn btn-info"><?php echo lang_key('see_full_documentation');?></a>
      </div>
    </div> 
<style type="text/css">
  .version{
