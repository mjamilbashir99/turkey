...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> <?php echo lang_key('all_categories Post');?></h3>
        <div class="box-tool">
           ...
           <tbody>
        	<?php $i=1;foreach($posts->result() as $row):?>
               <tr>
                  ...
                  <td data-title="<?php echo lang_key('title');?>" class="numeric"><a href="<?php echo site_url('admin/categorypost/edit/'.$row->id);?>"><?php echo lang_key($row->name);?></a></td>
  <td data-title="<?php echo lang_key('type');?>" class="numeric"><?php echo lang_key($row->description);?></a></td>

                    <td data-title="<?php echo lang_key('type');?>" class="numeric"><a href="<?php echo site_url('admin/categorypost/edit/'.$row->id);?>"><?php
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          <li><a href="<?php echo site_url('admin/categorypost/edit/'.$row->id);?>"><?php echo lang_key('edit');?></a></li>
                          <li><a href="<?php echo site_url('admin/categorypost/delete/'.$row->id);?>"><?php echo lang_key('delete');?></a></li>
                      </ul>
                    </div>
                  </td>
               </tr>
