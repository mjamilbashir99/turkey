...
$parent_categories = $CI->post_model->get_all_post_categories_by_article();
//var_dump($parent_categories->result());
?>
<div class="s-widget">
    <!-- Heading -->
    <h5><i class="fa fa-folder color"></i>&nbsp; <?php echo lang_key('Destination Base Categories') ?></h5>
    <!-- Widgets Content -->
        ...
        <ul class="list-6">
            ...
            ?>
                <li class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                 <a href="<?php echo site_url('article-posts/?category='.$parent->id);?>">
