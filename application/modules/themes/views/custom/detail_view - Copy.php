...
<div class="container real-estate" style="padding-top: 10px">
  ...
  <?php $full_address = get_formatted_address($post->address, $post->city, $post->state, $post->country, $post->zip_code); ?>
      ...
      <img src="<?php echo get_thumbs_image($app[0]->featured_img); ?>" class="img-responsive img-thumbnail" align="left"/>
                                 </div>
                              <div class="col-sm-6">
                              <h2 style="border-bottom:none;">&nbsp;</h2>
                                     <h2 style="border-bottom:none; margin-bottom:0px; margin-top:-7px;">
                                    	<a href="<?php site_url('apps_details/'.$app[0]->id)?>"><?php echo $app[0]->title;?></a>
                                    </h2>
                                    <label>App Description:</label>
                                    <p style="height:50px"><?php echo $app[0]->description;?></p>
                                        <div class="col-sm-3">
                                        <a href="<?php echo $app[0]->android?>">
                                        <img src="<?php echo theme_url();?>/assets/img/android-icon.png" width="40" />
                                        </a>
                                        </div> 
                                        <div class="col-sm-3"><a href="<?php echo $app[0]->mac?>">
                                        <img src="<?php echo theme_url();?>/assets/img/mac-icon.png" width="40" />
                                        </a>
                                        </div>
                                        <div class="col-sm-3"><a href="<?php echo $app[0]->window?>">
                                        <img src="<?php echo theme_url();?>/assets/img/win8-icon.png" width="40" />
                                        </a>
                                        </div>
                                        <div class="col-sm-3"><a href="<?php echo $app[0]->qr?>">
                                         <img src="<?php echo get_thumbs_image($app[0]->qr); ?>" width="48" />
                                        </a>
                                        </div>
                            </div>
                          <div class="col-sm-12" style="text-align:center;">
                                  <?php
									...
									{   
									   ...
									   foreach($apps as $app)
									   {
											if($i>1)
											echo " | ";
											  echo "<a href='".site_url("apps_details/".$app->id)."'>App $i</a>";
											$i++;  
                   					   }
									  }
									?>
                  ...
                  <h4 class="info-subtitle"><i class="fa fa-book"></i> Feature Emagazine</h4>
                            <div class="col-sm-4">
                            <h2 style="border-bottom:none; margin-bottom:0px;"><br />

                                <img src="<?php echo get_thumbs_image($issues[0]->featured_img); ?>" class="img-responsive img-thumbnail" align="left"/></h2>
                            
                            </div>
                            <div class="col-sm-8">
                        	    <h2 style="border-bottom:none; margin-bottom:0px;"><br />
                            <?php echo $issues[0]->name;?> </h2>
                               
                                   <strong>Frequency  : </strong><?php echo $magazine->magazine_frequency;?> &nbsp;&nbsp;&nbsp;&nbsp; 
                                   <strong> Language  : </strong><?php echo $magazine->magazine_language;?>
                                   &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; 
                                   <strong> Year  : </strong><?php echo $issues[0]->year;?>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <p><?php echo $issues[0]->description;?></p>
                                        ...
                                        <div class="col-sm-3">
                                        <a href="<?php echo $magazine->android?>">
                                        <img src="<?php echo theme_url();?>/assets/img/android-icon.png" width="40" />
                                        </a>
                                        </div>
                                        <div class="col-sm-3"><a href="<?php echo $magazine->mac?>">
                                        <img src="<?php echo theme_url();?>/assets/img/mac-icon.png" width="40" />
                                        </a>
                                        </div>
                                        <div class="col-sm-3"><a href="<?php echo $magazine->window?>">
                                        <img src="<?php echo theme_url();?>/assets/img/win8-icon.png" width="40" />
                                        </a>
                                        </div> 
                                        <div class="col-sm-3"><a href="<?php echo $magazine->qr?>">
                                        <img src="<?php echo get_thumbs_image($magazine->qr); ?>" width="48" />
                                        </a>
                                        </div>
                            	</div>
                                  </div>    
                                ...
                                <a href="<?php echo $issue->url;?>">Issue  <?php echo $n ?> |</a>
