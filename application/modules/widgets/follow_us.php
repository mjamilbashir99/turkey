<h5 class="bold"><i class="fa fa-user"></i>  About</h5>
                    ...
                    <div class="brand-bg">
                        <!-- Social Media Icons -->
                        <a class="facebook" href="https://www.facebook.com/visitcomtr"><i class="fa fa-facebook circle-3"></i></a>
                        <a class="twitter" target="_blank" href="https://twitter.com/visitcomtr"><i class="fa fa-twitter circle-3"></i></a>
...
<?php if(@file_exists('./sitemap.xml')){?>
    <h3 class="widget-title"><?php echo lang_key('site_map');?></h3>
